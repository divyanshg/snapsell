  ...
  return (
    <>
      <View style={tw`ml-4 w-full `}>
        ...
        <Text style={tw`text-gray-400`}>Add Product Images(Up to 8)</Text>
        <Text style={tw`text-gray-400 mt-2`}>Product Details</Text>
        <TextInput
        ...
        <View style={tw`flex items-center right-55 absolute bottom-10`}>
          <AddNew style={tw``} text={"Add Product"} to="" />
        </View>
      </View>
    </>
  );
...
export default ProductsFullDetail;
